...
import { faBed, faCamera, faHome, faMonument, faPerson, faPhone, faSearch } from '@fortawesome/free-solid-svg-icons'
...
const Header = ({type}) => {
  ...
  return (
    <div className='h-container'>
        <div className="h-row">
            <div className="h-col">
                <Link to="/">Apna Safar.</Link>
            </div>
            <div className="h-col">
                { user? (
                
                    <>
                        <span style={{color:"white", fontWeight: "600", fontSize:"18px",marginRight:"5px"}}>{user.username}</span>
            ...
            <div className={type === "smallHeader" ? "h-col smallHeader" : "h-col"}>
                <div className="icons">
                    ...
                    <div className="icon">
                        ...
                        <Link to='#city' smooth>Explore</Link>  
                    </div>
                    <div className="icon">
                        <FontAwesomeIcon icon={faMonument} />
                        <Link to='#tops' smooth>Wonders</Link>  
                    </div>
                    <div className="icon">
                        <FontAwesomeIcon icon={faCamera} />
                        <Link to='#grid' smooth>Attractions</Link>  
                    </div>
                    <div className="icon">
